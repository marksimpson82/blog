...
```
// <Name>Find types that are complicated</Name>
SELECT METHODS FROM ASSEMBLIES "IceCream.Framework"
WHERE ILNestingDepth >= 5
AND CyclomaticComplexity > 10
...
**Complicated nesting**
```
// <Name>Find methods that have horrible nesting</Name>
SELECT TOP 10 METHODS
WHERE ILNestingDepth >= 7
AND !FullNameLike "Parser"
```

**Complicated methods**
```
// <Name>Find complex methods</Name>
SELECT TOP 10 METHODS
WHERE CyclomaticComplexity >= 10
AND !FullNameLike "Parser"
ORDER BY CyclomaticComplexity DESC
```
...
```
// <Name>Suspect coverage for complicated types</Name>
SELECT TOP 10 METHODS
WHERE PercentageCoverage < 50
ORDER BY CyclomaticComplexity DESC
```

**'Popular' types with poor test coverage**
```
// <Name>Suspect coverage for popular types</Name>
SELECT TOP 10 TYPES
WHERE PercentageCoverage < 50
ORDER BY TypeRank DESC
```
